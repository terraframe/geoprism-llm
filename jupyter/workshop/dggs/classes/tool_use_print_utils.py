...
def header():
    ...
    print("- What is the total number of students in schools where the water level is greater than 18.2?")
    print("- List the school zones with schools where the water level is greater than 18.2?")    
    print("")
