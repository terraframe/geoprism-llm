...
def header():
    ...
    print("- List 10 power infrastructure locations which are impacted when the water level is 0.5?")
    print("- What is the total population impacted when the water level is 0.5?")    
    print("")
